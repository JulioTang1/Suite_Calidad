...
namespace Saml
{
	...
	public class Response
	{
        ...
        internal static void Redirect(string v)
        {
	...
	public class AuthRequest
	{
		...
		//returns the URL you should redirect your users to (i.e. your SAML-provider user URL with the Base64-ed request in the querystring
