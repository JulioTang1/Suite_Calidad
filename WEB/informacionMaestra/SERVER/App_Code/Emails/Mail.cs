...
public class Mail
{
    ...
    public static void SendEmailState(string nombre, string email, string estado, string rol, string app, string cat)
    {
        String mail;
        String password;
        String nombreRemitente;
        ...
        stringBuilder.Append("Actualización de ESTADO - Central Cervecera");
        ...
        stringBuilder.Append("<img src=\"https://centralcervecera.optiplan.co/imagenes/CC.png\" style =\"max-width: 80%;max-height: 90%;margin: auto;\">");
        ...
        stringBuilder.Append("Hola <strong>" + nombre + "</strong>,<br><br>El estado y rol de su cuenta ha sido cambiados a:<br><br>");
        ...
        stringBuilder.Append("En el módulo <strong>" + app + "</strong> de la categoría <strong>" + cat + "</strong><br><br>");
