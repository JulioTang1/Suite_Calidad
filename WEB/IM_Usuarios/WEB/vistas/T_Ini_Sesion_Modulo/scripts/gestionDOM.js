...
T_Ini_Sesion_Modulo.gestionDOM = new Object();

T_Ini_Sesion_Modulo.gestionDOM.dateSelected = function(){
	...
	$("#divTablaHistorico").append(`
		<div class="container_DataTable movil">
			<div id="divtabla_0" class="dataTableStyle tab-pane c_shadow rounded">		
				...
				<table id="tablaT_Ini_Sesion_Modulo" class="table-striped table-bordered" data-order='[[ 0, "asc" ]]' data-page-length='100'>
    ...
    gestionDT.initTable(
    	T_Ini_Sesion_Modulo.urlConexion,
    	"T_Ini_Sesion_Modulo", 
    	"#tablaT_Ini_Sesion_Modulo", 
		T_Ini_Sesion_Modulo.gestionDOM.tablaCargada,
		0,
        data
    ); 
}

T_Ini_Sesion_Modulo.gestionDOM.tablaCargada = function(e, settings, json){
